...
function createLangContainer(lang) {
  ...
  if (lang == "en") {
    element.innerHTML = `<div class="sr" onclick="changeLanguage('sr')"><img src="images/sr.webp" width="24" alt="srpska zastava"><span class="lang-container-sr">Srpski</span></div>`;
    switchHandler.appendChild(element);
  } else {
      element.innerHTML = `<div class="en" onclick="changeLanguage('en')"><img src="images/en.webp" width="24" alt="english flag"><span class="lang-container-en">English</span></div>`;
      switchHandler.appendChild(element);
  }
